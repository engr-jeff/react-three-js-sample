...
// change name, change function to arrow, change location
const Bike = (props) => {
  ...
  useFrame((_, dT) => {
    // firstMesh.current.rotation.y -= dT;
    // secondMesh.current.rotation.z -= dT;
  })

  useEffect(() => {
    // you can do changes on start, on any bike part
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Bike.geometry} material={materials.Quadro}>
        ...
        <mesh ref={secondMesh} geometry={nodes.B_Raios.geometry} material={materials.Raio} position={[-1.053, -1.178, 0.005]} />
